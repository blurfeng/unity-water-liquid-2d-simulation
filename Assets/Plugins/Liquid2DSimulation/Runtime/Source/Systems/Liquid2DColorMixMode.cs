namespace Fs.Liquid2D
{
    ...
    /// Fluid particle color-mixing algorithm mode (global setting, controlled via <see cref="Liquid2DSimulation.ColorMixMode"/>).
    ...
    public enum Liquid2DColorMixMode
    {
        ...
        /// Oklab perceptually-uniform color-space mixing (default). Natural transitions, no grey collapse.
        ...
        /// RYB pigment color-wheel mixing (artistic primaries: red–yellow–blue). Blue + Yellow → Green; mimics real paint.
