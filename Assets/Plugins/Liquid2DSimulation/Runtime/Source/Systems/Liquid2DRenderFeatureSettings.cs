...
namespace Fs.Liquid2D
{
    ...
    public class Liquid2DRenderFeatureSettings
    {
        ...
        // 注意（2022 移植）：UnityEngine.RenderingLayerMask 结构体是 2023.1+/URP16+ 才有的，2022.3/URP14 无此类型，
        // 故改用 uint（URP14 的 FilteringSettings.renderingLayerMask 本就是 uint）。Inspector 里表现为数值字段。
        public uint ObstructorRenderingLayerMask;
        ...
        // 注意（2022 移植）：同上，RenderingLayerMask → uint。
        public uint OccluderRenderingLayerMask;
