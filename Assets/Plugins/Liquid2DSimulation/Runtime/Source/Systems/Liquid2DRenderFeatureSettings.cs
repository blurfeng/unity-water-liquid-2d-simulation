...
namespace Fs.Liquid2D
{
    ...
    public class Liquid2DRenderFeatureSettings
    {
        ...
        public class Blur
        {
            ...
            [LocalizationTooltip("渲染缩放比例，越大性能越好，但边界越不清晰。",
            ...
            [LocalizationTooltip("是否忽略背景色。启用后，背景色将不参与模糊计算，模糊时仅使用流体颜色(但实际上任然会受到一些影响)。补充说明：模糊算法实际上是对每个像素点和边缘颜色进行混合，所以流体粒子颜色会受到背景色影响，越靠近边缘越明显。",
            ...
            [SerializeField, ColorUsage(true, true), LocalizationTooltip("流体模糊背景色。作为模糊时底图的颜色，最终影响整体水体的边缘色（默认为当前相机场景纹理颜色）。",
            ...
            [Range(0f, 1f), LocalizationTooltip("流体模糊背景色强度。0时不使用背景色（默认为当前相机场景纹理颜色），1为完全显示背景色。",
        ...
        public class Distort
        {
            ...
            [LocalizationTooltip("扰动时间系数。用于控制不同噪点的运动速度和方向。",
            ...
            [LocalizationTooltip("噪点坐标偏移。用于避免噪点纹理的重复性。",
        ...
        public class Pixel
        {
            ...
            [Range(1, 32), LocalizationTooltip("像素化尺寸，值越大像素化效果越明显。",
            ...
            [LocalizationTooltip("是否使用像素化背景色。开启后，在流体透明的情况下，背景色会被像素化。",
        ...
        [LocalizationTooltip("2D流体 Renderer Feature 名称标签，用于区分不同的 Renderer Feature 配置。",
             "2D fluid Renderer Feature name tag, used to distinguish different Renderer Feature configurations.",
             "2D流体レンダラーフィーチャーの名前タグ、異なるレンダラーフィーチャー設定を区別するために使用されます。")]
        public string nameTag = "Liquid2D";
        
        [LocalizationTooltip("2D流体层遮罩。只会渲染设定的流体层的粒子。",
        ...
        [LocalizationTooltip("液体阻挡层遮罩。指定哪些层的物体会阻挡液体效果。一般是挡板或容器等，他们会完全阻挡液体及时自身是透明的。相当于阻挡物的横截面。",
        ...
        [Range(0f, 1f), LocalizationTooltip("流体透明边缘的裁剪阈值，越大边缘越锐利，水体范围膨胀越少。",
        ...
        [LocalizationTooltip("透明度计算模式。",
             "Opacity calculation mode.",
             "透明度計算モード。")]
        public EOpacityMode opacityMode = EOpacityMode.Default;
        
        [Range(0f, 1f), LocalizationTooltip("透明度值，根据模式作用到最终的流体颜色。",
        ...
        [ColorUsage(true, true), LocalizationTooltip("覆盖颜色会覆盖流体粒子自身的颜色，作为流体的整体色调。alpha为强度，1时完全覆盖粒子颜色，0时不覆盖。",
        ...
        [LocalizationTooltip("流体模糊设置。",
             "Fluid blur settings.",
             "流体ブラー設定。")]
        public Blur blur;
        
        [LocalizationTooltip("流体扭曲设置。",
             "Fluid distortion settings.",
             "流体歪み設定。")]
        public Distort distort;
        
        [LocalizationTooltip("流体边缘设置。",
             "Fluid edge settings.",
             "流体エッジ設定。")]
        public Edge edge;
        
        [LocalizationTooltip("流体像素化设置。用于生成像素化风格效果。",
